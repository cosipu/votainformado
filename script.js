            ...
            list.forEach((c) => {
                ...
                if (Array.isArray(c.elecciones) && c.elecciones.length) {
                    ...
                    const distritosNuevos = ["distrito 1", "distrito 2", "distrito 3", "distrito 4", "distrito 5", "distrito 6",
                        ...
                        "distrito 15", "distrito 16", "distrito 17", "distrito 18", "distrito 19", "distrito 20", "distrito 21", "distrito 22", "distrito 23", "distrito 24",
                        "distrito 25",
                        "distrito 26", "distrito 27", "distrito 28"];
